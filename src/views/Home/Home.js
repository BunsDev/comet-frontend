...
const Home = () => {
  ...
  const tombFtmLpStats = useLpStats('COMET-FTM-LP');
  const tShareFtmLpStats = useLpStats('METEOR-FTM-LP');
  ...
  const tombLpZap = useZap({ depositTokenName: 'COMET-FTM-LP' });
  const tshareLpZap = useZap({ depositTokenName: 'METEOR-FTM-LP' });
    ...
    <Page>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={8}>
          <Paper>
            <Box p={4}>
              <h2>Welcome to Comet Finance</h2>
              <p>The most sustainable algorithmic stable coin on Fantom Opera, pegged to the price of 1 FTM via seigniorage.</p>
              <p>
                Stake your COMET-FTM LP in the Farm to earn METEOR rewards.
                Then stake your earned METEOR in the Milkyway to earn more COMET!
              </p>
              { isMStart && !isMOver ? 
                <a href="/farm" style={{fontSize:"24px", fontWeight:"600"}}>Meteor Reward Pools are live now!</a> : !isMStart ?
                <div style={{display:'flex'}}>
                  Meteor Reward Pools Launch In: <ProgressCountdown base={moment().toDate()} hideBar={true} deadline={mfrom} description="Pool Start" />
                </div> : null 
              }
              <br/>
              { isStart && !isOver ? 
        ...
        <Grid container spacing={3}>
          <Grid item  xs={12} sm={12} style={{ margin: '12px', display: 'flex' }}>
            <Alert variant="filled" severity="warning" style={{width: '100%', background: '#b648bd'}}>
              <b> Please visit our <StyledLink target="_blank" href="https://comet-finance88.gitbook.io/untitled/">documentation</StyledLink> before purchasing COMET or METEOR!</b>
            </Alert>
        </Grid>
        </Grid>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <Button
                onClick={() => {
                  tombFinance.watchAssetInMetamask('COMET');
                }}
                color="default"
                variant="outlined"
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <Button
                onClick={() => {
                  tombFinance.watchAssetInMetamask('METEOR');
                }}
                color="default"
                variant="outlined"
                style={{ position: 'absolute', top: '10px', right: '10px' }}
        ...
        <Grid item xs={12} sm={6}>
          <Card>
            <CardContent align="center">
              <h2>COMET-FTM Spooky LP</h2>
              <Box mt={2}>
                <CardIcon>
                  <TokenSymbol symbol="COMET-FTM-LP" />
                </CardIcon>
              </Box>
              <Box mt={2}>
              ...
              <Box mt={2}>
                <span style={{ fontSize: '26px' }}>
                  {tombLPStats?.tokenAmount ? tombLPStats?.tokenAmount : '-.--'} COMET /{' '}
        ...
        <Grid item xs={12} sm={6}>
          <Card>
            <CardContent align="center">
              <h2>METEOR-FTM Spooky LP</h2>
              <Box mt={2}>
                <CardIcon>
                  <TokenSymbol symbol="METEOR-FTM-LP" />
                </CardIcon>
              </Box>
              <Box mt={2}>
              ...
              <Box mt={2}>
                <span style={{ fontSize: '26px' }}>
                  {tshareLPStats?.tokenAmount ? tshareLPStats?.tokenAmount : '-.--'} METEOR /{' '}
