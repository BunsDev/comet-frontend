...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  const tombAddr = tombFinance.COMET.address;
  const tshareAddr = tombFinance.METEOR.address;

  let pairName: string;
  let uniswapUrl: string;
  if (bank.depositTokenName.includes('COMET')) {
    pairName = 'COMET-FTM pair';
    uniswapUrl = 'https://spookyswap.finance/add/FTM/' + tombAddr;
  } else {
    pairName = 'METEOR-FTM pair';
